...
var projectionAlbers = d3.geo.albers().scale(500).center([0, 33.44]).rotate([112.07, 0]).translate([920, 850]);

var projectionMercator = d3.geo.mercator()
    .center([0, 5 ])
    .scale(100)
    .rotate([-180,0]);
...
function ready(error, world, countryData) {
  ...
  function drawMarkers(){
    ...
    //   .style("fill", "red"); 
      ...
      g.selectAll("circle")
       .data(data)
           //.data({type: "GeometryCollection", geometries: circles})
  ...
  // g.selectAll("path").datum(topojson.feature(world, world.objects.land))
  //     .attr("class", "land")
